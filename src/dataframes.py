...
from caete import worker, region
...
class gridded_data:
    ...
    @staticmethod
    def read_grd(grd, variables, spin_slice):
        ...
        """
        data = grd._get_daily_data(get_args(variables), spin_slice, return_time=True)
        time = data[-1]
        data = data[0]
    ...
    def aggregate_region_data(r: region,
        ...
        Args:
            ...
            Defaults to None, read all available data.
    ...
    def create_masked_arrays(data: dict):
        """ Reads a dict generated by make_array and reorganize the data
        as masked_arrays with shape=(time, lat, lon) for each variable

        Args:
            data (dict): a dict generated by make_array
