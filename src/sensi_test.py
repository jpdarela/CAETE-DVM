...
run_path = Path(
    "/home/jdarela/Desktop/caete/CAETE-DVM/outputs/r0/RUN_r0_.pkz")
pls_path = Path(
    "/home/jdarela/Desktop/caete/CAETE-DVM/outputs/r0/pls_attrs.csv")

# Experiment - No eCO2 - HISTORICAL

# new outputs folder
dump_folder = Path("r0_exp_NOeCO2_HIST")
