...
if __name__ == "__main__":
    ...
    obsclim_files =  "../input/20CRv3-ERA5/obsclim_test/" # "../input/20CRv3-ERA5/obsclim_pan_amazon_forest/"
    spinclim_files = "../input/20CRv3-ERA5/spinclim_test/" # "../input/20CRv3-ERA5/spinclim_pan_amazon_forest/"
