...
asd = tb.Float64Col(dflt=0.0, pos=39) {
       'csoil': ((4, 3652), dtype('float64')),
       'snc': ((8, 3652), dtype('float64')),
       'lnc': ((6, 3652), dtype('float64')),
        'nupt': ((2, 3652), dtype('float64')),
        'pupt': ((3, 3652), dtype('float64')),

       'area': ((1000, 3652), dtype('float64')),
        'c_cost': ((1000, 3652), dtype('float32')),

        'lim_status': ((3, 1000, 3652), dtype('int16')),
        'u_strat': ((2, 1000, 3652), dtype('int32')),
        'storage_pool': ((3, 3652
