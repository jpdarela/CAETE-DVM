...
plt.ylabel("Abundância normalizada pela biomassa (adimensional)")
plt.xticks(np.array([]))
plt.xlabel("389 anos")
...
print("")
plt.title("Estabilização do Carbono no solo durante o spinup")
plt.ylabel("Carbono orgânico no solo g(C)m⁻²")
plt.xticks(np.array([]))
plt.xlabel("389 anos")
