...
- Scientific vegetation modeling framework
- Requires compilation of Python extension modules
- Uses Fortran backend for computational performance
...
### Key Components
- Bias-corrected data in `_raw` folders
...
### Alternative Option
- **MSVC/gfortran**: WinLibs distribution
- Tested: GCC 14.2.0 + MinGW-w64 12.0.0 (UCRT)
...
## Slide 9: Available Data Downloads
...
### Grid Configurations
- Pre-configured gridlists available
- City-specific grids
- Pan-Amazon forest grids
- Custom grid generation supported

---

## Slide 10: Quick Start Summary
...
**Ready to model vegetation dynamics! 🌱**
